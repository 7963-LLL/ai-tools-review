#!/usr/bin/env python3
"""Update index.html + daily.html for 2026-08-18"""
import json, re
...
featured_title = "Cursor 推出 Origin 代码托管：被 SpaceX 收购后首张牌，AI 原生托管正面挑战 GitHub"
featured_summary = ("8 月 17 日，Cursor 正式推出 Origin 代码托管服务，以早期公测形式向全部付费用户开放——仓库、Pull Request、"
                    "代码浏览与 GitHub 双向同步四项基础能力先行，Agent 原生功能随后跟上。就在三天前（8 月 14 日），Cursor 官宣"
                    "完成被 SpaceX 收购的交易，将获得全球最大 GPU 机队来训练更便宜、更强的模型。从编辑器到代码托管，从模型到算力，"
                    "Anysphere 正在搭建一条完整闭环，直指 GitHub 的护城河。")

# ========== 2. index.html ==========
with open('index.html', encoding='utf-8') as f:
    idx = f.read()

# --- 2e. Review card dates FIRST (7 occurrences incl. featured meta) ---
count = idx.count('📅 2026-08-16</span>')
idx = idx.replace('📅 2026-08-16</span>', f'📅 {TODAY}</span>')
...
new_featured = f'''  <div class="featured-card">
    ...
    <div class="featured-visual">
      <img src="images/featured-{TODAY}-1.jpg" alt="Cursor Origin 代码托管官方发布图 | Cursor" style="width:180px;border-radius:8px;object-fit:cover;height:100px;">
    </div>
  </div>'''
